...
class Listar
{
	...
	public function getLista( $id )
	{
		...
		if( $id == 6 ) {
			...
			$this->lista = GMySqli::getRegisters( 'Bebidas', array( 'idBebida', 'nombreBebida', 'precio' ) );
		} else {
	...
	{			
		$this->lista = GMySqli::getRegisters( 'Menus', array( 'idMenu', 'nombreMenu', 'precio' ), 
	...
	public function getListaPizzas(){
		$this->lista = GMySqli::getRegisters( 'Pizzas', array( 'idPizza', 'nombrePizza', 'precio' ) );
